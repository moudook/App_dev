...
-- Version: 3.0 (Deep Research Agent Support)
-- Date: 2026-03-06
-- =============================================================================
...
-- ALTER TABLE research_progress_files ENABLE ROW LEVEL SECURITY;

-- =============================================================================
-- CHANGELOG
-- =============================================================================
-- v3.0 (2026-03-06): Deep Research Agent Support
--   - Added research_sessions table
--   - Added research_searches table
--   - Added research_citations table
--   - Added research_logs table
--   - Added research_progress_files table
--   - Added timeout tracking (12min warning, 15min forced completion)
--   - Added user interruption support
