...
## What to Put Here
If you're creating a file that contains:
- Sensitive information (names, companies, personal details)
- Detailed bug descriptions with context
- Temporary experiments or research
- Screenshots of development issues
- Personal reference materials

**→ Put it in this `_private/` directory!**

## What NOT to Put Here
- Production code
- Public documentation (use main project folders)
- Shared configuration files
- README files for the main project
