...
class PrivacyGuard(private val logger: Logger, private val messageProvider: SecurityMessageProvider) {
    companion object {
        ...
        /**
         * Static convenience method - filters notes for AI visibility
         */
        fun getAiVisibleNotes(notes: List<Note>): List<Note> = defaultInstance.getAiVisibleNotes(notes)
         ...
         */
        fun canAiProcess(note: Note): Boolean = defaultInstance.canAiProcess(note)
