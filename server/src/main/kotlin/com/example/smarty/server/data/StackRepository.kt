...
class StackRepository(private val dataSource: DataSource) {
    ...
    suspend fun createStack(stack: Stack): String = withContext(Dispatchers.IO) {
    ...
    suspend fun getStacksForUser(userId: String): List<Stack> = withContext(Dispatchers.IO) {
    ...
    suspend fun getStackById(stackId: String): Stack? = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
    ...
    suspend fun updateStack(stack: Stack): Boolean = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
                UPDATE stacks SET
    ...
    suspend fun deleteStack(stackId: String): Boolean = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
    ...
    suspend fun addNoteToStack(noteId: String, stackId: String): Boolean = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
    ...
    suspend fun removeNoteFromStack(noteId: String, stackId: String): Boolean = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
    ...
    suspend fun getStacksForNote(noteId: String): List<Stack> = withContext(Dispatchers.IO) {
        val stacks = mutableListOf<Stack>()
        dataSource.connection.use { conn ->
            val sql = """
    ...
    suspend fun getNotesForStack(stackId: String): List<String> = withContext(Dispatchers.IO) {
