...
class QueryBuilder private constructor(
    ...
    companion object {
         ...
         */
        fun select(tableName: String, columns: List<String> = listOf("*")): QueryBuilder =
            QueryBuilder(tableName, columns)
     ...
     */
    fun whereUser(userId: String): QueryBuilder = apply {
     ...
     */
    fun whereEquals(column: String, value: Any?): QueryBuilder = apply {
     ...
     */
    fun whereIsNull(column: String): QueryBuilder = apply {
     ...
     */
    fun whereIsNotNull(column: String): QueryBuilder = apply {
     ...
     */
    fun whereTimestampAfter(column: String, timestamp: Long): QueryBuilder = apply {
     ...
     */
    fun whereCustom(sql: String, vararg params: Any?): QueryBuilder = apply {
    ...
    fun build(): Pair<String, List<Any?>> {
        ...
        val fullSql = listOf(baseSql, whereSql, orderSql, limitSql, offsetSql)
     ...
     */
    fun <T> execute(conn: Connection, mapper: (ResultSet) -> T): List<T> {
    ...
    private fun copy(
        ...
        tableName, columns, whereClauses, whereParams, orderBy, limit, offset
    )
}
...
class UpdateBuilder(private val tableName: String) {
     ...
     */
    fun set(column: String, value: Any?): UpdateBuilder = apply {
     ...
     */
    fun setUpdatedAtNow(): UpdateBuilder = apply {
     ...
     * Add WHERE clause.
     */
    fun where(column: String, value: Any?): UpdateBuilder = apply {
        whereClauses.add("$column = ?")
        whereParams.add(value)
    }
     ...
     */
    fun whereUser(userId: String): UpdateBuilder = apply {
        whereClauses.add("user_id = ?")
        whereParams.add(UUID.fromString(userId))
    }
...
class InsertBuilder(private val tableName: String) {
     ...
     */
    fun column(column: String, value: Any?): InsertBuilder = apply {
        columns.add(column)
        values.add(value)
    }
     ...
     * Add UUID column.
     */
    fun uuidColumn(column: String, uuidString: String): InsertBuilder = apply {
        columns.add(column)
     ...
     */
    fun nowColumn(column: String): InsertBuilder = apply {
        columns.add(column)
     ...
     */
    fun executeWithGeneratedKey(conn: Connection, keyMapper: (ResultSet) -> String): String {
        val (sql, params) = build()
...
class DeleteBuilder(private val tableName: String) {
     ...
     * Add WHERE clause.
     */
    fun where(column: String, value: Any?): DeleteBuilder = apply {
        whereClauses.add("$column = ?")
        whereParams.add(value)
    }
     ...
     * Add WHERE clause for user_id.
     */
    fun whereUser(userId: String): DeleteBuilder = apply {
        whereClauses.add("user_id = ?")
        whereParams.add(UUID.fromString(userId))
    }
