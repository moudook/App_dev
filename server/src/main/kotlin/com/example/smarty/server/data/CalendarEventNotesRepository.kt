...
class CalendarEventNotesRepository(private val dataSource: DataSource) {
     ...
     */
    suspend fun linkEventToNote(eventId: UUID, noteId: UUID): Unit = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun unlinkEventFromNote(eventId: UUID, noteId: UUID): Boolean = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
     ...
     */
    suspend fun getLinkedNotes(eventId: UUID): List<UUID> = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun getLinkedEvents(noteId: UUID): List<UUID> = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun deleteAllForEvent(eventId: UUID): Int = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
                DELETE FROM calendar_event_notes
                WHERE event_id = ?
     ...
     */
    suspend fun linkMultipleNotesToEvent(eventId: UUID, noteIds: List<UUID>): Unit = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
     ...
     */
    suspend fun isLinked(eventId: UUID, noteId: UUID): Boolean = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
     ...
     */
    suspend fun getLinkCountForEvent(eventId: UUID): Int = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
