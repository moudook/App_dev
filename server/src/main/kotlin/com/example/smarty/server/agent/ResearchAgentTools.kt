...
/**
 * Research Agent Tools - Limited toolset for focused research.
 * Only web search and notes-related tools (no distractions).
 */
object ResearchAgentTools {
    
    /**
     * Get all tools available to Research Agent
     */
