...
class ChatMessageNotesRepository(private val dataSource: DataSource) {
     ...
     */
    suspend fun linkMessageToNote(messageId: UUID, noteId: UUID): Unit = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun unlinkMessageFromNote(messageId: UUID, noteId: UUID): Boolean = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
     ...
     */
    suspend fun getLinkedNotes(messageId: UUID): List<UUID> = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun getLinkedMessages(noteId: UUID): List<UUID> = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun deleteAllForMessage(messageId: UUID): Int = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
                DELETE FROM chat_message_notes
                WHERE message_id = ?
     ...
     */
    suspend fun deleteAllForNote(noteId: UUID): Int = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
                DELETE FROM chat_message_notes
                WHERE note_id = ?
     ...
     */
    suspend fun linkMultipleNotesToMessage(messageId: UUID, noteIds: List<UUID>): Unit = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
     ...
     */
    suspend fun isLinked(messageId: UUID, noteId: UUID): Boolean = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
     ...
     */
    suspend fun getLinkCountForMessage(messageId: UUID): Int = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
     ...
     */
    suspend fun getLinkCountForNote(noteId: UUID): Int = withContext(Dispatchers.IO) {
        dataSource.connection.use { conn ->
            val sql = """
                SELECT COUNT(*) as count FROM chat_message_notes
                WHERE note_id = ?
