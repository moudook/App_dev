...
class ChatMessageNotesRepositoryTest {
    ...
    fun testLinkMessageToNote() = runTest {
        // Arrange
    ...
    fun testPreventDuplicateLinks() = runTest {
        // Arrange
        val userId = "test-user-123"
        val messageId = createTestMessage(userId)
        val noteId = createTestNote(userId)
    ...
    fun testUnlinkMessageFromNote() = runTest {
        // Arrange
        val userId = "test-user-123"
        val messageId = createTestMessage(userId)
        val noteId = createTestNote(userId)
    ...
    fun testGetLinkedNotesEmpty() = runTest {
        // Arrange
    ...
    fun testLinkMultipleNotes() = runTest {
        // Arrange
        val userId = "test-user-123"
        val messageId = createTestMessage(userId)
    ...
    fun testGetLinkedMessages() = runTest {
        // Arrange
        val userId = "test-user-123"
    ...
    fun testDeleteAllForMessage() = runTest {
        // Arrange
        val userId = "test-user-123"
        val messageId = createTestMessage(userId)
        val noteId1 = createTestNote(userId)
    ...
    fun testDeleteAllForNote() = runTest {
        // Arrange
        val userId = "test-user-123"
        val messageId1 = createTestMessage(userId)
        val messageId2 = createTestMessage(userId)
