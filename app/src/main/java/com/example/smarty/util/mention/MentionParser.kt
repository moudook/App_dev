...
object MentionParser {
    ...
    fun getTypeFilterDisplayName(context: android.content.Context, type: com.example.smarty.data.model.NoteType): String {
        return when (type) {
            ...
            com.example.smarty.data.model.NoteType.WEB_CLIPPING -> context.getString(com.example.smarty.R.string.mention_type_websites)
        }
    }
    ...
    fun getTypeFilterKeyword(type: com.example.smarty.data.model.NoteType): String {
        return when (type) {
            ...
            com.example.smarty.data.model.NoteType.WEB_CLIPPING -> "web"
        }
    }
