...
object ThemeAwareColors {
    ...
    @Composable
    @ReadOnlyComposable
    fun surfaceVariant(alpha: Float = 1f): Color {
    ...
    @Composable
    @ReadOnlyComposable
    fun dialogBorder(): Color {
        return outlineVariant(0.4f)
    }
