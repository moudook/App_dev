    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            SmartyTheme(darkTheme = isDarkThemeTop) {
                ...
                val pendingApprovalToolId by viewModel.pendingApprovalToolId.collectAsState()
                ...
                // HOISTED STATE: Input attachments
                val currentInputAttachments by viewModel.currentInputAttachments.collectAsState()
                    ...
                    Crossfade(
                        ...
                        when (state) {
                            ...
                            "login" -> {
                                ...
                                LaunchedEffect(Unit) {
                                    viewModel.setShakeBlocked(true)
                                }
                            ...
                            "main_app" -> {
                                ...
                                LaunchedEffect(Unit) {
                                    viewModel.setShakeBlocked(false)
                                }
