...
class MemorySyncWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        try {
            ...
            val repository = com.example.smarty.data.repository.SmartyRepository(
                noteDao = noteDao,
            ...
            val noteOperationsManager = com.example.smarty.features.notes.domain.NoteOperationsManager(
