package com.example.smarty.features.notes.ui.widget
...
class QuickNoteWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        private fun updateAppWidget(
            ...
            val voicePendingIntent =
                PendingIntent.getActivity(
                    context,
                    appWidgetId + 1000,
                    voiceIntent, // Unique RequestCode
                    PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE,
                )
            ...
            val cameraPendingIntent =
                PendingIntent.getActivity(
                    context,
                    appWidgetId + 2000,
                    cameraIntent, // Unique RequestCode
                    PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE,
                )
        ...
        fun updateAllWidgets(context: Context) {
            val intent =
                Intent(context, QuickNoteWidgetProvider::class.java).apply {
