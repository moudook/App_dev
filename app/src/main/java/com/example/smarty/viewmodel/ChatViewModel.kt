...
class ChatViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val isThinkingModeEnabled = chatFeatureManager.isThinkingModeEnabled
    val aiPlanStatus = chatFeatureManager.aiPlanStatus
    val currentToolName = chatFeatureManager.currentToolName
    val navigationRequest = chatFeatureManager.navigationRequest
