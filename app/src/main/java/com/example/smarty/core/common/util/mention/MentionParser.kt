...
object MentionParser {
     ...
     */
    fun getTypeFilterDisplayName(context: android.content.Context, type: com.example.smarty.core.domain.model.NoteType): String {
        return when (type) {
            ...
            com.example.smarty.core.domain.model.NoteType.SPREADSHEET -> context.getString(com.example.smarty.R.string.mention_type_spreadsheets)
            com.example.smarty.core.domain.model.NoteType.PRESENTATION -> context.getString(com.example.smarty.R.string.mention_type_presentations)
            com.example.smarty.core.domain.model.NoteType.BRAIN_DUMP -> context.getString(com.example.smarty.R.string.mention_type_braindumps)
            ...
            com.example.smarty.core.domain.model.NoteType.WEB_CLIPPING -> context.getString(com.example.smarty.R.string.mention_type_websites)
        }
    }
