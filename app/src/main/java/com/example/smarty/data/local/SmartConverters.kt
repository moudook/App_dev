...
class SmartConverters {
    ...
    @TypeConverter
    fun fromTagType(type: TagEntity.TagType?): String? = type?.name
    ...
    @TypeConverter
    fun fromTaskStatus(status: TaskEntity.TaskStatus?): String? = status?.name
    ...
    @TypeConverter
    fun fromPermission(permission: SharedItemEntity.Permission?): String? = permission?.name
    ...
    @TypeConverter
    fun fromCheckpointType(type: AgentCheckpointEntity.CheckpointType?): String? = type?.name
    ...
    @TypeConverter
    fun fromDigestType(type: DailyDigestEntity.DigestType?): String? = type?.name
    ...
    @TypeConverter
    fun fromSearchType(type: SearchHistoryEntity.SearchType?): String? = type?.name
    ...
    @TypeConverter
    fun fromBoolean(value: Boolean?): Int = if (value == true) 1 else 0
