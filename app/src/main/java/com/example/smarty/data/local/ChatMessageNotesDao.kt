...
interface ChatMessageNotesDao {
    ...
    suspend fun isLinked(messageId: String, noteId: String): Boolean
    ...
    @Transaction
    suspend fun linkMessageToNote(messageId: String, noteId: String) {
    ...
    @Transaction
    suspend fun unlinkMessageFromNote(messageId: String, noteId: String) {
