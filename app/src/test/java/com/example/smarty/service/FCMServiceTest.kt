...
class FCMServiceTest {
    ...
    @Test
    fun onNewToken_cachesTokenAndSendsToServer() =
        testScope.runTest {
            // Given
    ...
    @Test
    fun onMessageReceived_handlesDataPayload() =
        testScope.runTest {
            // Given
    ...
    @Test
    fun onMessageReceived_handlesNotificationPayload() =
        testScope.runTest {
            // Given
            val mockMessage = mockk<com.google.firebase.messaging.RemoteMessage>(relaxed = true)
    ...
    @Test
    fun onDestroy_cancelsServiceScope() =
        testScope.runTest {
            // Given
            ...
            assertTrue(
                fcmService.tokenState.value is TokenState.Cached ||
                    fcmService.tokenState.value is TokenState.Unknown,
            )
        }

    @Test
    fun tokenState_flowEmitsOnTokenUpdate() =
        testScope.runTest {
            // Given
    ...
    @Test
    fun service_handlesNullNotificationFields() =
        testScope.runTest {
            // Given
            val mockMessage = mockk<com.google.firebase.messaging.RemoteMessage>(relaxed = true)
            every { mockMessage.data } returns emptyMap()
    ...
    @Test
    fun service_handlesEmptyDataPayload() =
        testScope.runTest {
            // Given
            val mockMessage = mockk<com.google.firebase.messaging.RemoteMessage>(relaxed = true)
            every { mockMessage.data } returns emptyMap()
