...
class NotesFeatureTest {
    ...
    @Test
    fun `create note with valid data succeeds`() = runTest {
        // Given
        val noteData = TestBuilders.note {
            title = "Test Note"
    ...
    @Test
    fun `create note with empty title fails`() = runTest {
        // Given
        val noteData = TestBuilders.note {
            title = ""
            content = "Test content"
    ...
    @Test
    fun `update note preserves metadata`() = runTest {
        // Given
    ...
    @Test
    fun `delete note removes from repository`() = runTest {
        // Given
    ...
    @Test
    fun `filter notes by category returns matching notes`() = runTest {
        // Given
    ...
    @Test
    fun `filter archived notes returns only archived`() = runTest {
        // Given
        val notes = listOf(
    ...
    @Test
    fun `filter pinned notes returns only pinned`() = runTest {
        // Given
        val notes = listOf(
    ...
    @Test
    fun `filter favorite notes returns only favorites`() = runTest {
        // Given
        val notes = listOf(
    ...
    @Test
    fun `search notes by title returns matches`() = runTest {
        // Given
        val notes = listOf(
    ...
    @Test
    fun `search notes by content returns matches`() = runTest {
        // Given
        val notes = listOf(
    ...
    @Test
    fun `search with empty query returns all notes`() = runTest {
        // Given
        val notes = listOf(
    ...
    @Test
    fun `private note is marked as private`() = runTest {
        // Given
        val note = TestBuilders.note {
            title = "Private note"
            isPrivate = true
    ...
    @Test
    fun `private note is excluded from AI context`() = runTest {
        // Given
        val privateNote = TestBuilders.note {
            title = "Private"
            isPrivate = true
        }
        val publicNote = TestBuilders.note {
            title = "Public"
            isPrivate = false
        }
    ...
    @Test
    fun `note without category has null category`() = runTest {
        // Given
        val note = TestBuilders.note {
            title = "Uncategorized"
            categoryName = null
    ...
    @Test
    fun `note with category has valid category`() = runTest {
        // Given
        val note = TestBuilders.note {
            title = "Work note"
            categoryName = "Work"
    ...
    @Test
    fun `notes can be moved between categories`() = runTest {
        // Given
        val note = TestBuilders.note {
            categoryName = "Work"
        }
    ...
    @Test
    fun `sort notes by date returns newest first`() = runTest {
        // Given
        val oldNote = TestBuilders.note {
            createdAt = System.currentTimeMillis() - 86400000 // 1 day ago
        }
        val newNote = TestBuilders.note {
    ...
    @Test
    fun `sort notes by title alphabetically`() = runTest {
        // Given
        val notes = listOf(
    ...
    @Test
    fun `pinned notes appear first when sorting`() = runTest {
        // Given
        val unpinned = TestBuilders.note {
            title = "Unpinned"
            active()
        }
        val pinned = TestBuilders.note {
            title = "Pinned"
            pinned()
        }
    ...
    @Test
    fun `note with attachments has non-empty list`() = runTest {
        // Given
        val note = TestBuilders.note {
    ...
    @Test
    fun `note without attachments has empty list`() = runTest {
        // Given
        val note = TestBuilders.note {
            title = "Simple note"
        }
    ...
    @Test
    fun `note with todos tracks completion`() = runTest {
        // Given
        val note = TestBuilders.todoNote {
            title = "Shopping list"
    ...
    @Test
    fun `todo completion percentage is calculated correctly`() = runTest {
        // Given
        val note = TestBuilders.todoNote {
    ...
    @Test
    fun `note word count is calculated correctly`() = runTest {
        // Given
        val note = TestBuilders.note {
    ...
    @Test
    fun `note created timestamp is set on creation`() = runTest {
        // Given
    ...
    @Test
    fun `note updated timestamp changes on update`() = runTest {
        // Given
        val originalNote = TestBuilders.note {}
