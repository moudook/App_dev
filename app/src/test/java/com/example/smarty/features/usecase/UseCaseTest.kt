...
class UseCaseTest {
    ...
    @Test
    fun `create note validates title not empty`() =
        runTest {
    ...
    @Test
    fun `create note validates title not null`() =
        runTest {
    ...
    @Test
    fun `create note succeeds with valid data`() =
        runTest {
    ...
    @Test
    fun `update note validates note exists`() =
        runTest {
    ...
    @Test
    fun `search notes returns matching results`() =
        runTest {
            val notes =
                listOf(
    ...
    @Test
    fun `create event validates title not empty`() =
        runTest {
    ...
    @Test
    fun `create event validates end time after start time`() =
        runTest {
            val now = System.currentTimeMillis()
    ...
    @Test
    fun `create event succeeds with valid data`() =
        runTest {
            val now = System.currentTimeMillis()
    ...
    @Test
    fun `send message validates content not empty`() =
        runTest {
    ...
    @Test
    fun `send message validates session id not empty`() =
        runTest {
    ...
    @Test
    fun `send message succeeds with valid data`() =
        runTest {
...
class NoteRepository {
    suspend fun create(note: com.example.smarty.core.domain.model.Note): Result<com.example.smarty.core.domain.model.Note> =
        Result.success(note)
...
class CalendarRepository {
    ...
    ): Result<com.example.smarty.core.domain.model.CalendarEvent> = Result.success(event)
...
class ChatRepository {
    suspend fun saveMessage(
        message: com.example.smarty.core.domain.model.ChatMessage,
    ): Result<com.example.smarty.core.domain.model.ChatMessage> = Result.success(message)
