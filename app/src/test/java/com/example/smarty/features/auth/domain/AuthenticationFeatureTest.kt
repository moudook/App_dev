...
class AuthenticationFeatureTest {
    ...
    @Test
    fun `login with weak password fails`() =
        runTest {
            val email = "user@example.com"
            val password = "123"
    ...
    @Test
    fun `logout clears session successfully`() =
        runTest {
    ...
    @Test
    fun `check session returns true for authenticated user`() =
        runTest {
    ...
    @Test
    fun `check session returns false for unauthenticated user`() =
        runTest {
    ...
    @Test
    fun `get current user returns user when authenticated`() =
        runTest {
            val mockUser =
                AuthUser(
                    uid = "user-123",
    ...
    @Test
    fun `get current user returns null when not authenticated`() =
        runTest {
            coEvery { authRepository.getCurrentUser() } returns null
    ...
    @Test
    fun `refresh token succeeds for authenticated user`() =
        runTest {
    ...
    @Test
    fun `refresh token fails for unauthenticated user`() =
        runTest {
    ...
    @Test
    fun `password reset email sent successfully`() =
        runTest {
            val email = "user@example.com"
    ...
    @Test
    fun `password reset with invalid email fails`() =
        runTest {
            val email = "invalid-email"
    ...
    @Test
    fun `login error is propagated correctly`() =
        runTest {
            val email = "user@example.com"
    ...
    @Test
    fun `network error is handled gracefully`() =
        runTest {
