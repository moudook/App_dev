...
class SearchFeatureTest {
    ...
    @Test
    fun `search notes by title returns matching results`() =
        runTest {
            val notes =
                listOf(
    ...
    @Test
    fun `search notes by content returns matching results`() =
        runTest {
            val notes =
                listOf(
    ...
    @Test
    fun `search notes by category returns matching results`() =
        runTest {
            val notes =
                listOf(
    ...
    @Test
    fun `search with multiple terms returns relevant results`() =
        runTest {
            val notes =
                listOf(
    ...
    @Test
    fun `search events by title returns matching results`() =
        runTest {
            val events =
                listOf(
    ...
    @Test
    fun `search events by location returns matching results`() =
        runTest {
            val events =
                listOf(
    ...
    @Test
    fun `combined search returns notes and events`() =
        runTest {
            val notes =
                listOf(
    ...
    @Test
    fun `filter search results by date range`() =
        runTest {
    ...
    @Test
    fun `filter search results by type`() =
        runTest {
    ...
    @Test
    fun `filter search results by privacy`() =
        runTest {
            val items =
                listOf(
    ...
    @Test
    fun `rank results by relevance - title match ranks higher`() =
        runTest {
            val items =
                listOf(
                    TestBuilders.note {
    ...
    @Test
    fun `save search query to history`() =
        runTest {
    ...
    @Test
    fun `limit search history to recent queries`() =
        runTest {
            val history = mutableListOf<String>()
            val maxHistory = 5
    ...
    @Test
    fun `search with special characters handles gracefully`() =
        runTest {
            val notes =
                listOf(
    ...
    @Test
    fun `search handles null values gracefully`() =
        runTest {
            val notes =
                listOf(
                    TestBuilders.note {
    ...
    @Test
    fun `search excludes archived items by default`() =
        runTest {
            val notes =
                listOf(
                    TestBuilders.note {
