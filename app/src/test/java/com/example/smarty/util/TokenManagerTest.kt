...
class TokenManagerTest {
    ...
    @Test
    fun cacheToken_storesTokenAndUpdatesState() = testScope.runTest {
        // Given
    ...
    @Test
    fun getCachedToken_returnsNullWhenNoToken() = testScope.runTest {
        // When
        val cachedToken = tokenManager.getCachedToken()
    ...
    @Test
    fun hasValidCachedToken_returnsTrueForFreshToken() = testScope.runTest {
        // Given
    ...
    @Test
    fun markAsRegistered_updatesStateToRegistered() = testScope.runTest {
        // Given
    ...
    @Test
    fun clearCachedToken_removesTokenAndResetsState() = testScope.runTest {
        // Given
    ...
    @Test
    fun tokenState_flowEmitsOnChanges() = testScope.runTest {
        // Given
    ...
    @Test
    fun failedOperation_updatesStateToFailed() = testScope.runTest {
        // When
