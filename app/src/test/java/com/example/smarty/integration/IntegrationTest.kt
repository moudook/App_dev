...
class IntegrationTest {
    ...
    @Test
    fun testUserCreationAndSyncState() =
        runBlocking {
            // Create user
            val user =
                UserEntity(
