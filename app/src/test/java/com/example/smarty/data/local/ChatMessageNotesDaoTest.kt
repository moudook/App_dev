...
class ChatMessageNotesDaoTest {
    ...
    @Test
    fun insertAndQueryLinkedNote() = runTest {
        // Arrange
    ...
    @Test
    fun linkMultipleNotesToMessage() = runTest {
        // Arrange
        val messageId = UUID.randomUUID().toString()
    ...
    @Test
    fun preventDuplicateLinks() = runTest {
        // Arrange
        val messageId = UUID.randomUUID().toString()
        val noteId = UUID.randomUUID().toString()
    ...
    @Test
    fun getLinkedMessagesForNote() = runTest {
        // Arrange
    ...
    @Test
    fun deleteAllForMessage() = runTest {
        // Arrange
        val messageId = UUID.randomUUID().toString()
        val noteId1 = UUID.randomUUID().toString()
        val noteId2 = UUID.randomUUID().toString()
