...
class BackupRestoreTest {
    ...
    @Test
    fun excludeFromAiChatFlagPersists() =
        runBlocking {
            val excludedNote =
                createTestNote(
                    id = "excluded-note",
    ...
    @Test
    fun multipleNotesInsertAndRetrieve() =
        runBlocking {
            val notes =
                (1..10).map { i ->
                    createTestNote(
    ...
    @Test
    fun summaryAndSuggestionsPersist() =
        runBlocking {
            val note =
                createTestNote(
                    id = "summary-test",
    ...
    @Test
    fun restorePreservesPrivacyFlags() =
        runBlocking {
